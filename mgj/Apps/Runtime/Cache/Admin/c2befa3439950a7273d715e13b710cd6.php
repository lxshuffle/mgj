                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="<?php echo U('Admin/User/trach');?>">会员回收站</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo U('Admin/Link/add');?>">链接添加</a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Admin/Link/index');?>">链接列表</a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Admin/Link/trach');?>">回收站</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li> 
                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                        	<div class="row">
                                <form action="<?php echo U('Admin/Link/trach');?>" method="get">
                                    <div class="col-sm-6">
                   ...
                   <tbody>
                    ...
                    <?php if(is_array($res)): foreach($res as $key=>$vo): ?><tr class="gradeA odd" role="row">
                            ...
                            <td>
                                ...
                                <a href="<?php echo U('Admin/Link/hf',array('id'=>$vo['id']));?>"><button type="button" class="btn btn-primary">恢复</button></a></td>
                            </td>
